...
public class PostServiceImpl implements PostService {
  ...
  public PostDto createPost(PostDto postDto, Integer userId, Integer categoryId) {
    ...
    Cateory category = this.categoryRepo.findById(categoryId)
        .orElseThrow(() -> new ResourceNotFoundException("Category", "category id", categoryId));

    Post post = this.modelMapper.map(postDto, Post.class);
    post.setInageName("default.png");
    post.setAddedData(new Date());
    post.setUser(user);
  ...
  public PostDto updatePost(PostDto postDto, Integer postId) {
    ...
    post.setInageName(postDto.getInageName());
  ...
  public PostDto getPostById(Integer postId) {
    ...
    Post post = this.postRepo.findById(postId)
        .orElseThrow(() -> new ResourceNotFoundException("Post", "post id", postId));
    return this.modelMapper.map(post, PostDto.class); // gt the object of PostDto
  }
